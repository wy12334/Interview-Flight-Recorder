...
| 面试列表 | 复习计划 | 数据统计 | 设置页面 |
|---|---|---|---|
| <img src="./页面展示截图/01-面试列表.png" width="220" alt="面试列表"> | <img src="./页面展示截图/02-复习计划.png" width="220" alt="复习计划"> | <img src="./页面展示截图/15-数据统计.png" width="220" alt="数据统计"> | <img src="./页面展示截图/04-设置页面.png" width="220" alt="设置页面"> |
